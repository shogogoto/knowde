...
def test_3layers() -> None:
    ...
    # p13 <- p22
    # p21, p22 <- p31
    d11 = add_definition(_p("p11", "s11"))
    d12 = add_definition(_p("p12", "s12"))
    d13 = add_definition(_p("p13", "s13"))
    d21 = add_definition(_p("p21", "{p11}{p12}"))
    d22 = add_definition(_p("p22", "{p13}"))
    d31 = add_definition(_p("p31", "{p21}{p22}"))
