...
from tanbun.feature.parsing.sysnet.systats.nw1_n1.ctxdetail import Nw1N1Detail
from tanbun.feature.parsing.sysnet.systats.nw1_n1.scorable import (
    NRecursiveWeight,
    SyScore,
)

if TYPE_CHECKING:
    from tanbun.feature.parsing.sysnet.systats.types import Nw1N1Label, Nw1N1Recursive
